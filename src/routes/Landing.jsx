      ...
      <div className="landing-scroll" style={{ paddingTop: "80px" }}>
        ...
        <section className="hero mentorloop-hero">
          <div className="hero-left">
            ...
            <Link to="/register" className="cta-button">Join the Movement</Link>
          </div>
        ...
        <section className="pricing" id="pricing">
          ...
          <p className="pricing-footer">
            💬 Need help choosing a plan? <Link to="/demo">Book a Demo</Link> and we’ll guide you through the perfect fit.
          </p>
        </section>
      </div>
    </>
